                        ...
                        return (
                          <li key={item.id}>
                            <button
                              ...
                              className="group grid w-full grid-cols-[7.5rem_minmax(0,1fr)_auto] items-center gap-3 rounded-[var(--radius-md)] px-2 py-2 text-left outline-none transition-colors duration-[var(--motion-standard)] hover:bg-surface-hover focus-visible:ring-3 focus-visible:ring-ring/40 active:translate-y-px"
