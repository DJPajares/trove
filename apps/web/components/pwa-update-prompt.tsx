...
export function PwaUpdatePrompt() {
  ...
  return (
    <div className="fixed right-[max(0.75rem,var(--safe-right))] bottom-[calc(var(--bottom-bar-height)+var(--safe-bottom)+var(--nav-action-overhang)+0.75rem)] left-[max(0.75rem,var(--safe-left))] z-[var(--layer-notice)] mx-auto max-w-md sm:left-auto sm:right-[max(1rem,var(--safe-right))] md:bottom-[calc(1rem+var(--safe-bottom))]">
